...
namespace NAN_TEST
{
    ...
    void NanTestSuite::ndpInterfaceCreate(int argc, char **argv)
    {
                ...
                long_options, &long_index )) != -1)
        {
            switch (opt)
            {
                case 'z':
                    ...
                    break;
                case 'i':
                   strlcpy((char*)iface_name, optarg, strlen(iface_name) + 1);
        ...
        nan_data_interface_create(id, ifaceHandle, iface_name);
    }
    ...
    void NanTestSuite::ndpInterfaceDelete(int argc, char **argv)
    {
        ...
        nan_data_interface_delete(id, ifaceHandle, iface_name);
    }
                ...
                long_options, &long_index )) != -1)
        {
            switch (opt)
            {
                case 'a' :
                    ...
                    break;
                case 'd':
                    req.service_instance_id = atoi(optarg);
                    break;
                case 'c':
