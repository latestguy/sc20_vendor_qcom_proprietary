...
public:
  ...
  sp<AMessage> getTrackInfo(size_t index);
  status_t getTrackCount();
  status_t populateTrackInfo();
  bool addTrackInfoEntry(media_track_type eTrackType, AString sMimeType, char* sLang);
 ...
 OMX_INDEXTYPE mWatermarkStatusExtIndex;
  ...
  public:
    ...
    */
    ...
    void setMimeType(AString sMimeType)
    {
