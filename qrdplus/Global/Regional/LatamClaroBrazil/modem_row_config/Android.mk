...
MODEM_ROW_CONFIG_FOLDER := $(TARGET_OUT)/vendor/LatamClaroBrazil/data/modem_row_config/msm8917
...
include $(CLEAR_VARS)
MODEM_ROW_CONFIG_FILE := mcfg_sw.mbn
MODEM_ROW_CONFIG_FOLDER := $(TARGET_OUT)/vendor/LatamClaroBrazil/data/modem_row_config/msm8909
$(shell mkdir -p $(MODEM_ROW_CONFIG_FOLDER))
$(shell cp -r $(addprefix $(LOCAL_PATH)/, $(res_dirs))/msm8909/$(MODEM_ROW_CONFIG_FILE) $(MODEM_ROW_CONFIG_FOLDER)/$(MODEM_ROW_CONFIG_FILE))

include $(CLEAR_VARS)
MODEM_ROW_CONFIG_FILE := mcfg_sw.mbn
MODEM_ROW_CONFIG_FOLDER := $(TARGET_OUT)/vendor/LatamClaroBrazil/data/modem_row_config/msm8909_3
$(shell mkdir -p $(MODEM_ROW_CONFIG_FOLDER))
...
include $(CLEAR_VARS)
MODEM_ROW_CONFIG_FILE := mcfg_sw.mbn
MODEM_ROW_CONFIG_FOLDER := $(TARGET_OUT)/vendor/LatamClaroBrazil/data/modem_row_config/msm8953
$(shell mkdir -p $(MODEM_ROW_CONFIG_FOLDER))
