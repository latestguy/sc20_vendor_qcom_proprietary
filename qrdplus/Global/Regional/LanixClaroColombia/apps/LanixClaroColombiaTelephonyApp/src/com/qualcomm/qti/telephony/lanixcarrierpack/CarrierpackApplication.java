...
public class CarrierpackApplication extends Application{
    ...
    private static final boolean DBG = true;//Log.isLoggable(CarrierpackApplication.TAG, Log.DEBUG);
    ...
    public boolean isPersoLocked() {
        ...
        return sim.getState() == State.NETWORK_LOCKED;
    }
    ...
    private void registerNpLock() {
        ...
        if (sim != null) {
            ...
            sim.registerForNetworkLocked(mHandler, EVENT_PERSO_LOCKED, null);
        }
    }
