...
public class WifiApHelpActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Res.getSettingsBoolean(this, Res.FLAG_HOTSPOT_HELP_ENABLE)){
            ...
            ((TextView) findViewById(R.id.content_view_settings_indication_step1)).setText(Res
                    .getSettingsString(this, Res.STRING_WIFIAP_SETTINGS_INDICATION_STEP1));
        }
    ...
    private String getWifiApSsid() {
        ...
        if(Res.getSettingsBoolean(this, Res.FLAG_HOTSPOT_HELP_ENABLE)){
            ...
            return getString(R.string.wifiap_settings_indication_step2, wifiApConfig.SSID);
        }
    }
