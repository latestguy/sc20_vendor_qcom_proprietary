...
String8 OmaDrmEngine::onGetOriginalMimeType(int uniqueId, const String8& path,
    ...
    if (-1 < fileDesc) {
        ...
        if (NULL != pMimeType) {
            ...
            if (contentType == String8("audio/amr")
                    || contentType == String8("audio/amr-nb")
                    || contentType == String8("audio/amr-wb")
                    || contentType == String8("audio/aac")){
                mimeString = contentType;
            } else {
