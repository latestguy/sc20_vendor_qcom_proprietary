...
public class ConfigurationApplication extends Application {
    ...
    public void onCreate() {
        ...
        // Save the default BT name to reset the value
        String defaultBtName = Utils.getSharedPreference(
                this, Utils.SHARED_PREFERENCE_KEY_DEFAULT_BT_NAME);
        if (TextUtils.isEmpty(defaultBtName)) {
            defaultBtName = mAdapter.getName();
            Utils.setSharedPreference(mContext,
                    Utils.SHARED_PREFERENCE_KEY_DEFAULT_BT_NAME, defaultBtName);
        }
        ...
        if (TextUtils.isEmpty(Utils.getSharedPreference(this,
                Utils.SHARED_PREFERENCE_KEY_IS_PACK_FIRST_BOOT))) {
            if (mAdapter.isEnabled()) {
                Utils.setDefaultBtName(mContext);
            } else {
