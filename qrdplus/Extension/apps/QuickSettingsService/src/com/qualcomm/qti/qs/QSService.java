...
import com.qualcomm.qti.qs.tiles.AudioProfileTile;
...
public class QSService extends Service
{
    ...
    private QSTile createTile(String action) {
        ...
        else if (action.endsWith("audioprofiletile")) return new AudioProfileTile(mContext, action);
                    ...
                    for (QSTile tile : mQSTiles) {
                        if((intent.getAction()).
                            ...
                            tile.handleClick();
                                ...
                                equals(tile.getOnLongClickAction())) {
    ...
    public int onStartCommand (Intent intent, int flags, int startId)
    {
        ...
        for (QSTile tile : mQSTiles) {
            ...
            filter.addAction(tile.getOnLongClickAction());
        }
