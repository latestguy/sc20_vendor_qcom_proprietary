...
public abstract class RegistrationTask {
    ...
    private static final String SERVER_URI = "http://zzhc.vnet.cn:9999/";
    //private static final String SERVER_URI = "https://blog.csdn.net/";
    ...
    public RegistrationTask(Context context, int primayStackId, int primarySimPhoneId) {
        mRegistrationPairs = new RegistrationPairs(context, primayStackId, primarySimPhoneId) {

            @Override
            public void onDeviceInfosGot(JSONObject data) {
                Log.d(TAG, "onDeviceInfosGot-1");
    ...
    private String post(byte[] data) {
        ...
        try {
            ...
            Log.d(TAG, "SERVER_URI: " + SERVER_URI);
