...
public class RoamingTabsFragment extends Fragment {
    ...
    public static class TabManager implements TabHost.OnTabChangeListener {
        ...
        public void onTabChanged(String tabId) {
            ...
            if (mLastTab != newTab) {
                mSettingsFragment.onPhoneChanged(newTab.phoneId);
            }
            mLastTab = newTab;
        }

        public void addTab(TabSpec tabSpec, int phoneId) {
            tabSpec.setContent(new MyTabFactory(mFragment.getActivity()));
            String tag = tabSpec.getTag();

            TabInfo info = new TabInfo(tag, phoneId);
        ...
        static class TabInfo {
            ...
            TabInfo(String tag, int phoneId) {
                this.tag = tag;
