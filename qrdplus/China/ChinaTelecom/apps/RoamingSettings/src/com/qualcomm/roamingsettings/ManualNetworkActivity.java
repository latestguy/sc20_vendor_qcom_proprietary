...
public class ManualNetworkActivity extends Activity implements OnClickListener {
    ...
    private static final int EVENT_GET_NETWORK_SELECTION_MODE = 22;
...
//    private String postNOGSMManual;
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case EVENT_GET_NETWORK_SELECTION_MODE:
                Log.v(TAG, "handler EVENT_GET_NETWORK_SELECTION_MODE");
                int ints[];
                ...
                if (ar.exception == null) {
                    ...
                    Log.v(TAG, "GET_NETWORK_SELECTION_MODE success, isManual: " + ints[0]);
                } else {
                    Log.w(TAG, "GET_NETWORK_SELECTION_MODE Exception: " + ar.exception);
                }
                String msgString = getString(R.string.network_select_failure_info,mNetworkName);
                showNetworkSelectResultDialog(setAuto, msgString);
                break;
            ...
            case EVENT_NETWORK_SELECTION_DONE:
                ...
                if (ar.exception != null) {
                    ...
                    mPhone.getNetworkSelectionMode(mHandler.obtainMessage(EVENT_GET_NETWORK_SELECTION_MODE));
                } else {
...
//                mNetworkName = listview.getItemAtPosition(index).toString();
                ...
                mPhone.selectNetworkManually(mNetworkMap.get(index), false, msg);
            }
        });
    ...
    public void onClick(View v) {
        ...
        if (newNetworkMode != mNetworkMode) {
            ...
            selectNetworkMode(newNetworkMode);
        }
    }
    ...
    private class CdmaConfig {
        ...
        private void handleAvoidCurNwk(Message msg) {
            ...
            postNOCDMAManual = TelephonyManager.getDefault()
                    .getNetworkOperator(PhoneConstants.SUB1);
    ...
    private void showProgressDailog(String msgStr) {
        mProgressDialog = new ProgressDialog(getParentContext());
