...
public class SelectorAdapter extends ListIconAdapter {
    ...
    protected static List<ListIconItem> getData(Context context) {
        ...
        addListItem(data, context.getString(R.string.rcs_attach_take_photo),
                R.drawable.take_picture, PA_TAKE_PICTURE);

        addListItem(data, context.getString(R.string.rcs_attach_video),
                R.drawable.local_video, PA_ADD_VIDEO);

        addListItem(data, context.getString(R.string.rcs_attach_record_video),
                R.drawable.record_video, PA_RECORD_VIDEO);

        addListItem(data, context.getString(R.string.rcs_attach_sound), R.drawable.local_audio,
                PA_ADD_SOUND);

        addListItem(data, context.getString(R.string.rcs_attach_record_sound),
                R.drawable.record_audio, PA_RECORD_SOUND);

        addListItem(data, context.getString(R.string.rcs_attach_add_vcard),
                R.drawable.contact_vcard, PA_ADD_CONTACT_VCARD);

        addListItem(data, context.getString(R.string.rcs_attach_map),
                R.drawable.location_message, PA_ADD_MAP);
    ...
    protected static void addListItem(List<ListIconItem> data, String title, int resource,
            int command) {
