        ...
        if ("android.net.conn.CONNECTIVITY_CHANGE".equals(action)) {
            ...
            if("".equals(sharePreferenceImsi)){
                ...
                if(null != imsi && !imsi.equals(sharePreferenceImsi)){
                    try {
                        RichScreenApi.getInstance().clearRichScrnLocalCache(
                                SIM_CARD_HAS_BEEN_REPLACED);
                    } catch (Exception e) {
                ...
                try {
                    RichScreenApi.getInstance().clearRichScrnLocalCache(
                            COMPLETED_RESTORE_FACTORY_SETTINGS);
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
    ...
    private void updateRichScreenForAweek(){
        ...
        while(cursor.moveToNext()){
            ...
            while(phone.moveToNext()){
                ...
                try {
                    RichScreenApi.getInstance().downloadRichScrnObj(phoneNumber, DOWNLOAD_EVENT);
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
