...
DM_TREE_HANDLE dmTree_searchItem(DM_TREE_HANDLE treeHndl, const IS8* nodeUri) {
     ...
     *  Set Init uri
     */
    strlcpy(uri, lpTreeHndl->data->nodeUri, sizeof(uri));
...
DM_TREE_HANDLE dmTree_insertItem(DM_TREE_HANDLE treeHndl,
    ...
    if ((pszTmp = strrchr(newItem->nodeUri, '/')) != NULL ) {
        ...
        strlcpy(szNodeUri, newItem->nodeUri, nLen + 1);
...
DM_TREE_HANDLE dmTreeSml_insertItemEx(DM_TREE_HANDLE treeHndl,
    ...
    strlcpy(uri, lpParentItem->data->nodeUri, sizeof(uri));
    if (strlen(uri) >= (DMTREE_URI_MAXSIZE-1)) {
        dmTree_setErrorCode(DMTREE_ERR_URI_TOO_LONG);
        return NULL;
    }
    ...
    do {
        ...
        if (ptmp != NULL ) {
            ...
            if (lpInteItem == NULL ) {
                ...
                strlcpy(g_dmTreeTmpItem.nodeName, puri, sizeof(g_dmTreeTmpItem.nodeName));
                strlcpy(g_dmTreeTmpItem.nodeUri, uri, sizeof(g_dmTreeTmpItem.nodeUri));
                strlcpy(g_dmTreeTmpItem.nodeFormat, "node", sizeof(g_dmTreeTmpItem.nodeFormat));
...
IS32 dmTreeSml_replaceItemEx(DM_TREE_HANDLE treeHndl, IU32 replaceMask,
    ...
    if (replaceMask == DMTREE_REPLACE_NODENAME) {
        strlcpy(g_dmTreeTmpItem.nodeName, (IS8*) param, sizeof(g_dmTreeTmpItem.nodeName));
    }
    // node data
...
IS8* dmTreeDmAcc_getServerList(void) {
    ...
    while (nodeHndl != NULL ) {
        idHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, serverIDUri);
        if (idHndl != NULL && idHndl->data->nodeData != NULL ) {
            strlcpy(tmp, idHndl->data->nodeData, idHndl->data->dataSize + 1);
...
IS32 dmTreeDmAcc_getAccountInfo(const IS8* serverID, DMTREE_ACC_INFO* accInfo) {
    ...
    // Node name
    strlcpy(accInfo->accNodeName, nodeHndl->data->nodeName, sizeof(accInfo->accNodeName));
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_AppID, &itemUri,
        ...
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accAppID, itemHndl->data->nodeData, sizeof(accInfo->accAppID));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ServerID, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accServerId, itemHndl->data->nodeData, sizeof(accInfo->accServerId));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_Name, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accName, itemHndl->data->nodeData, sizeof(accInfo->accName));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_PrefConRef, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accPrefConRef, itemHndl->data->nodeData,
                    sizeof(accInfo->accPrefConRef));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ConRef, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accConRef, itemHndl->data->nodeData, sizeof(accInfo->accConRef));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_Addr, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accAddr, itemHndl->data->nodeData, sizeof(accInfo->accAddr));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_AddrType, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accAddrType, itemHndl->data->nodeData, sizeof(accInfo->accAddrType));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ServerAuthLevel, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accServerAuthLevel, itemHndl->data->nodeData,
                    sizeof(accInfo->accServerAuthLevel));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ServerAuthName, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accServerAuthName, itemHndl->data->nodeData,
                    sizeof(accInfo->accServerAuthName));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ServerPw, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accServerPw, itemHndl->data->nodeData,
                    sizeof(accInfo->accServerAuthName));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ServerNonce, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy((IS8*) accInfo->accServerNonce, itemHndl->data->nodeData,
                    sizeof(accInfo->accServerNonce));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_PrevServerNonce, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy((IS8*) accInfo->accPrevServerNonce, itemHndl->data->nodeData,
                    sizeof(accInfo->accPrevServerNonce));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ClientAuthLevel, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accClientAuthLevel, itemHndl->data->nodeData,
                    sizeof(accInfo->accClientAuthLevel));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_UserName, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accUserName, itemHndl->data->nodeData, sizeof(accInfo->accUserName));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_UserPw, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy(accInfo->accUserPw, itemHndl->data->nodeData, sizeof(accInfo->accUserPw));
    }
    ...
    if (dmTreeParam_getDmAccNodeName(dmAccNodeName_ClientNonce, &itemUri,
        ...
        itemHndl = (DMTREE_INTERNAL_ITEM*) dmTree_searchItem(
                (DM_TREE_HANDLE) nodeHndl, itemUri);
        if (itemHndl != NULL && itemHndl->data->nodeData != NULL )
            strlcpy((IS8*) accInfo->accClientNonce, itemHndl->data->nodeData,
                    sizeof(accInfo->accClientNonce));
    }
