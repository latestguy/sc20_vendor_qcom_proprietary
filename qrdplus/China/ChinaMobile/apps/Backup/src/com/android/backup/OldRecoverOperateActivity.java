...
public class OldRecoverOperateActivity extends PreferenceActivity implements OnVcsInsertListener {
    ...
    private static final String DEFAULT_BACKUP_ROOT_DIR = BackupUtils.strInternalPath
            + "/.backup/";
    ...
    private static final String DEFAULT_BACKUP_APP_DIR_FILE = BackupUtils.strInternalPath
