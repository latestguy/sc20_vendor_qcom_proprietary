...
public class ExtWifiReceiver extends BroadcastReceiver {
        ...
        if (Intent.ACTION_BOOT_COMPLETED.equals(action)) {
            ...
            if (state == DetailedState.CONNECTED) {
                ...
                if (isWifiConnected() &&
                    ...
                    // conncected.
                    if (mHighestPriorityNetworkId == -1 || !isManuallyDisconnectFromAp()
            ...
            if (wifiState == WifiManager.WIFI_STATE_DISABLED) {
                ...
                if (Utils.isWlan2CellularHintEnabled(context) &&
                        !Utils.isAirplaneModeOn(context)) {
                    showWlanDisconnectToast();
                }
            }
    ...
    private boolean isMobileDataEnabled() {
        ...
        if (tm.getSimCount() > 1) {
            ...
            Utils.log("Default data subId = " + subId);
    ...
    private void showSelectSsidDlg() {
        ...
        final int dataToWifiConnectType = Settings.Global.getInt(mContext.getContentResolver(),
    ...
    private void promptCellular2WlanDialog(Context context) {
        ...
        int dataToWifiConnectType = Settings.Global.getInt(context.getContentResolver(),
                Utils.DATA_TO_WIFI_CONNECT_TYPE, Utils.DATA_WIFI_CONNECT_TYPE_AUTO);
    ...
    private boolean isManuallyDisconnectFromAp() {
        boolean isManuallyDisconnect = Settings.Global.getInt(
        ...
        if (!isManuallyDisconnect) {
            Settings.Global.putInt(mContext.getContentResolver(), Utils.DISCONNECT_FROM_NETWORK,
                    Utils.NOT_MANUALLY_DISCONNECT_LAST_AVAILABLE_AP);
        }
    ...
    private void startService() {
        ...
        i.setClassName(mContext.getPackageName(), ExtWifiService.class.getName());
