 ...
 * preset networks.
 */
public class ExtWifiService extends Service {
    ...
    public void onCreate() {
        Utils.log("ExtWifiService created.");
    ...
    private class AutoConnectTypeObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            ExtWifiReceiver.resetCellularToWlanDialogControlParas();
        }
    }
    ...
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Utils.log("Service receive action: " + action);
    ...
    public void checkAndSavePresetNetwork(Context context) {
        ...
        Utils.log("checkAndSavePresetNetwork, "
        ...
        WifiManager.ActionListener mSaveListener = new WifiManager.ActionListener() {
            ...
            public void onFailure(int reason) {
                Utils.log("Service failed to save network, reason:" + reason);
            }
        };
        ...
        for (int i = 0; i < ssids.length; i++) {
            ...
            Utils.log("Service save network: " + config.SSID);
