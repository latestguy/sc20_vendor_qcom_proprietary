...
public class SubsidyLockSettingsObserver extends ContentObserver {
    ...
    public static int getSubsidySettings(Context context) {
        int subsidySettings = Settings.Secure.getInt(
                context.getContentResolver(), SUBSIDY_LOCK_SETTINGS, -1);
    ...
    private class SubsidySettingsHandler extends Handler {
        ...
        static final int ACTIVATION_DEACTIVATION_SUCCESS = 0;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                        ...
                        for (int i = 0; i < mNumSimSlots; i++) {
                            ...
                            if (mExtTelephony.isPrimaryCarrierSlotId(i)) {
                                ...
                                if (mExtTelephony.getCurrentUiccCardProvisioningStatus(i)
                                    ...
                                    if (result == ACTIVATION_DEACTIVATION_SUCCESS) {
                ...
                case MSG_SET_PRIMARY_CARD:
                    QtiPrimaryCardController.getInstance().trySetPrimarySub(true);
                    break;
            }
        }
    }
    ...
    private void updateDeviceState(int newState) {
        if (mCurrentState != newState) {
            ...
            if ((mCurrentState == PERMANENTLY_UNLOCKED) &&
                ...
                // to update mcc-mnc values(primary card priority is decided based on mcc-mnc values
                // hence this is needed) and run Primary card algorithm.
                mCardInfoManager.updateMccMncValues();
