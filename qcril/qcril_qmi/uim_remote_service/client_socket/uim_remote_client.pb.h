...
#define com_qualcomm_uimremoteclient_UimRemoteEventReq_poll_timer_tag 9
...
extern const pb_field_t com_qualcomm_uimremoteclient_UimRemoteEventReq_fields[10];
