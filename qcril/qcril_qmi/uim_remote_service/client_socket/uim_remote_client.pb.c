...
const pb_field_t com_qualcomm_uimremoteclient_UimRemoteEventReq_fields[10] = {
    ...
    PB_FIELD2(  9, UINT32  , OPTIONAL, STATIC  , OTHER, com_qualcomm_uimremoteclient_UimRemoteEventReq, poll_timer, disable_all_polling, 0),
    PB_LAST_FIELD
};
