...
public interface IZatGeofenceService {
     ...
     *         In case a registered callback is not found corresponding
     *         to the passed in handler,
     *         a {@link IZatIllegalArgumentException} will be thrown.
     * @throws IZatIllegalArgumentException
     */
    ...
    interface IZatGeofenceHandle {
         ...
         * registered.</p>
         * <p> If a registered callback is not found corresponding to this
         * handle, a {@link IZatIllegalArgumentException} will be thrown.</p>
         *
