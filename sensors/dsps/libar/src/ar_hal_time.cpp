...
hal_ts_offset_is( uint32_t timestamp_ssc, uint64_t timestamp_ap )
{
  ...
  do
  {
    ...
    HAL_LOG_DEBUG("%s: boottime_diff: %llu boottime_diff_best: %llu boottime_start_best: %lld boottime_end_best: %lld",
  ...
  HAL_LOG_DEBUG("%s: Apps: %" PRIu64"; DSPS: %u; Offset : %" PRId64 " (diff %llu @%d)",
