...
static void sns_detect_msm()
{
  ...
  {
    g_msm_type.msm_id = SNS_MSM_8992;
  }
  else if (!strcmp("msm8994", board_platform))
  {
    g_msm_type.msm_id = SNS_MSM_8994;
  }
  else if (!strcmp("msm8996", board_platform))
  {
    g_msm_type.msm_id = SNS_THULIUM;
  }
  else if (!strcmp("msm8952", board_platform))
  {
    g_msm_type.msm_id = SNS_MSM_8952;
  }
  else if (!strcmp("msm8909", board_platform))
  {
    g_msm_type.msm_id = SNS_MSM_8909W;
  }
  else if (!strcmp("msm8937", board_platform))
  {
    g_msm_type.msm_id = SNS_MSM_8937;
  }
  else
  {
