...
sns_rtb_s sns_rtb[] = {
    ...
    { SNS_PM_SVC_ID_V01,                  SNS_MODULE_DSPS_PM,   {NULL, 0, 0, 0},                              NULL }, /* 1 - DEPRECATED */
    ...
    { SNS_SAM_VMD_SVC_ID_V01,             SNS_MODULE_DSPS_SAM,  {NULL, 0, 0, 0},                              NULL }, /* 6 - DEPRECATED */
    ...
    { SNS_SAM_FNS_SVC_ID_V01,             SNS_MODULE_APPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 9 - DEPRECATED */
    { SNS_SAM_BTE_SVC_ID_V01,             SNS_MODULE_APPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 10 - DEPRECATED */
    ...
    { SNS_SMGR_INTERNAL_SVC_ID_V01,       SNS_MODULE_DSPS_SMGR, { NULL, 0, 0, 0},                             NULL }, /* 13 - DEPRECATED */
    ...
    { SNS_SAM_MAG_CAL_SVC_ID_V01,         SNS_MODULE_APPS_SAM,  {NULL, 0, 0, 0},                              NULL }, /* 16 - DEPRECATED */
    ...
    { SNS_SAM_TAP_SVC_ID_V01,             SNS_MODULE_APPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 26 - DEPRECATED */
    { SNS_SAM_FACING_SVC_ID_V01,          SNS_MODULE_APPS_SAM,  SAM_ON_APPS_SVC_OBJ(SAM_FACING, 01),          NULL }, /* 27 */
    { SNS_SAM_INTEG_ANGLE_SVC_ID_V01,     SNS_MODULE_APPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 28 - DEPRECATED */
    { SNS_SAM_GYRO_TAP_SVC_ID_V01,        SNS_MODULE_APPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 29 - DEPRECATED */
    { SNS_SAM_GYRO_TAP2_SVC_ID_V01,       SNS_MODULE_APPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 30 - DEPRECATED */
    { SNS_OEM_1_SVC_ID_V01,               SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(OEM_1, 01),                   NULL }, /* 31  - OEM Use Only */
    { SNS_OEM_2_SVC_ID_V01,               SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(OEM_2, 01),                   NULL }, /* 32  - OEM Use Only */
    { SNS_OEM_3_SVC_ID_V01,               SNS_MODULE_UNDEFINED, { NULL, 0, 0, 0},                             NULL }, /* 33  - OEM Use Only */
    { SNS_SAM_GYROBUF_SVC_ID_V01,         SNS_MODULE_DSPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 34 - DEPRECATED */
    ...
    { SNS_SAM_PAM_SVC_ID_V01,             SNS_MODULE_DSPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 38 - DEPRECATED */
    ...
    { SNS_SYNC_PROXY_SVC_ID_V01,          SNS_MODULE_DSPS_SAM,  { NULL, 0, 0, 0},                             NULL }, /* 50 */
    { SNS_SAM_QHEART_SVC_ID_V01,          SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_QHEART, 01),              NULL }, /* 51 */
    { SNS_SAM_FAST_AMD_SVC_ID_V01,        SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_FAST_AMD, 01),            NULL }, /* 52 */
    { SNS_SAM_TILT_W_DETECTOR_SVC_ID_V01, SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_TILT_W_DETECTOR,01),      NULL }, /* 53 */
    { SNS_SAM_IOD_SVC_ID_V01,             SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_IOD, 01),                NULL }, /* 54 */
    { SNS_SAM_IOD_AUTOCAL_SVC_ID_V01,     SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_IOD_AUTOCAL, 01),        NULL },  /* 55 */
    { SNS_QFP_SVC_ID_V01,                 SNS_MODULE_DSPS_SMGR, SNS_GET_SVC_OBJ(QFP, 01),                    NULL },  /* 56 */
    { SNS_SAM_MULTISHAKE_SVC_ID_V01,      SNS_MODULE_DSPS_SAM,  SNS_GET_SVC_OBJ(SAM_MULTISHAKE, 01),         NULL },  /* 57 */
};
