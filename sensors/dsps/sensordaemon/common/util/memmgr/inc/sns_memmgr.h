...
/*============================================================================
  ...
  $Header: //components/dev/ssc.adsp/2.6/gulansey.ssc.adsp.2.6.gulansey_sam42/common/util/memmgr/inc/sns_memmgr.h#1 $
  $DateTime: 2014/12/01 08:45:40 $
...
#else
#define SNS_UIMAGE_HEAP_SIZE (35 * 1024) // in bytes
#endif
