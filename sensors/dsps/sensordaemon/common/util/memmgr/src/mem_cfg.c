...
/*============================================================================
  ...
  ---------- --- -----------------------------------------------------------
  2014-12-08 ks  2x and 4x memory pools to handle highly concurrent use cases
...
*/
#define NUM_16_BYTE_BLOCKS  64    /* 1KB */
#define NUM_24_BYTE_BLOCKS  128   /* 3KB */
#define NUM_32_BYTE_BLOCKS  128   /* 4KB */
#define NUM_64_BYTE_BLOCKS  92    /* 6KB */
#define NUM_128_BYTE_BLOCKS 128   /* 16KB */
#define NUM_256_BYTE_BLOCKS 30    /* 7.6 KB */
#define NUM_512_BYTE_BLOCKS 96    /* 48KB */
#define NUM_1024_BYTE_BLOCKS 72   /* 72KB */
#define NUM_2048_BYTE_BLOCKS 50   /* 100KB */
