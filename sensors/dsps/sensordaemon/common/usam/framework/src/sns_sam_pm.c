...
==============================================================================*/
SNS_SAM_UIMAGE_CODE bool sns_sam_pm_ap_suspend()
{
  bool retVal;
  uint8_t os_err;
...
==============================================================================*/
SNS_SAM_UIMAGE_CODE sns_sam_err sns_sam_uimage_exit( sns_sam_uimage_blocking_type blockType)
{
  uint8_t os_err;
  sns_pm_err_code_e pm_err;
  sns_sam_err sam_err = SAM_ENONE;
  ...
  {
      SNS_PRINTF_STRING_ERROR_1(SNS_SAM_DBG_MOD, "SAM: Blocktype %d count 255!", blockType);
  }
