                                       ...
                                       uint8&  HIDType)
{
  ...
  switch(ucUsage)
  {
    ...
    case 0x0:
        ...
        MM_MSG_PRIO(MM_GENERAL, MM_PRIO_HIGH,"UIBCInputParser:ParseHIDInput Received HID_REPORT");
        break;
    case BIT0:
        hidDataType = HID_REPORT_DESCRIPTOR;
        MM_MSG_PRIO(MM_GENERAL, MM_PRIO_HIGH,"UIBCInputParser:ParseHIDInput Received HID_REPORT_DESCRIPTOR");
        break;
    default:
        MM_MSG_PRIO1(MM_GENERAL, MM_PRIO_HIGH,"UIBCInputParser:ParseHIDInput Unsupported HID type %d",ucUsage);
  }
