...
WFDSurfaceMediaSource::WFDSurfaceMediaSource(uint32_t bufferWidth, uint32_t bufferHeight, WFDSMSConsumerType eType) :
    mWidth(bufferWidth),
...
bool WFDSurfaceMediaSource::isMetaDataStoredInVideoBuffers() const {
