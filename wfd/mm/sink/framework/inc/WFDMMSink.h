...
private:
    ...
    void getSetBufferStartTimeFlag(int trackID, OMX_BUFFERHEADERTYPE *pBuffer, bool get);
    ...
    bool                     m_bMissedAudioStartTimeFlag;
    bool                     m_bMissedVideoStartTimeFlag;
    bool                     m_bMissedRendererBaseTimeSet;
    uint64                   m_nBaseTime;
