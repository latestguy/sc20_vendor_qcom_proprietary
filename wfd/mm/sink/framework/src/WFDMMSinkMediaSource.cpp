    ...
    switch(mediaStatus)
    {
        case FILE_SOURCE_DATA_OK:
            ...
            */
            ...
            if(!mbVideoStarted)
            {
                WFDMMLOGH("Video Buffer set STARTTIME flag");
                                                  ...
                                                  mnNewBaseTime)))
            {
                pBuffer->nFlags |= OMX_BUFFERFLAG_STARTTIME;
                mbVideoTimeReset = false;
                WFDMMLOGH("Video Buffer set STARTTIME flag after VideoTimeReset");
            }
        ...
        case FILE_SOURCE_DATA_OK:
            ...
            */
            ...
            if(mbAudioTimeReset)
            {
              ...
              {
                pBuffer->nFlags |= OMX_BUFFERFLAG_STARTTIME;
                WFDMMLOGH("Audio Buffer set STARTTIME flag after AudioTimeReset");
                mbAudioTimeReset = false;
              }
            }
