...
#define LOW_LATENCY_MODE_KEY "LowLatencyMode"
#define ENCODER_POWER_SAVE_MODE_KEY "EncoderPowerSaveMode"
#define ENCODER_REAL_TIME_MODE_KEY "EncoderRealTimeMode"
