...
*
*
*  Copyright (c) 2012 - 2013, 2015 by Qualcomm Technologies, Inc. All Rights Reserved.
...
public class UIBCManager {
    ...
    /* constructor */
    public UIBCManager(int devType) throws InstantiationException,
    ...
    /**
     * Enable UIBC on control path. This function is only called on WFD source
     * to trigger RTSP request. When RTSP response is received, start() is used
     * to start the data path.
     *
     * @return
     */
    ...
    /**
     * Disable UIBC on control path. This function is only called on WFD source
     * to trigger RTSP request. When RTSP response is received, stop() is used
     * to stop the data path.
     *
     * @return
     */
