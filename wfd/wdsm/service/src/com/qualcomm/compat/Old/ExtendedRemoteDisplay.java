    ...
    protected static ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName className) {
            ...
            Message messageTeardown =
                        eventHandler.obtainMessage(WFDCallback.TEARDOWN_CALLBACK);
            eventHandler.sendMessage(messageTeardown);

            Log.d(TAG, "Post Invalid");
            Message messageInvalid =
                        eventHandler.obtainMessage(WFDCallback.INVALID_STATE);
...
public final class ExtendedRemoteDisplay{
    ...
    private native int getNativeObject();
    private native Surface getSurface(int obj, int width, int height);
    private native int destroySurface(int obj, Surface surface);
    private native void destroyNativeObject(int obj);
            ...
            switch (msg.what) {
                    ...
                    try {
                        ...
                        if(mLocalWfdDevice != null) {
                            ServiceUtil.getInstance().
                                 init(ExtendedRemoteDisplay.this.mActionListener,
                ...
                case WFDCallback.TEARDOWN_CALLBACK: {
                    try {
                        ...
                        if (mPtr != 0) {
                            /* This instance is being deleted. Get
                               rid of the native object
                               and the surface*/
                ...
                case WFDCallback.MM_STREAM_START: {
                    ...
                    int width = Integer.parseInt(b.getString("width"));
                    int height = Integer.parseInt(b.getString("height"));
                    ...
                    /* Note that secure here doesn't Indicate the session is
                       ...
                       is played
                    */
                    int secure  = Integer.parseInt(b.getString("hdcp"));

                    Log.d(TAG, "MM Stream Started Height, width and secure: "
                                        + " " + b.getString("width")  + " " +
                                                b.getString("height") + " " +
                                                b.getString("hdcp"));
