...
void inspectHW() {
    ...
    /* Only check for 8956/8976 MDSS cases for 10 bit LUT depth*/
    if (gHwInfo.hwRevision == MDSS_MDP_HW_REV_111) {
        gHwInfo.nPriDisplayLutMaxVal = 1023;
        gHwInfo.nPriDisplayLutBitDepth = 10;
    } else {
        gHwInfo.nPriDisplayLutMaxVal = 255;
        gHwInfo.nPriDisplayLutBitDepth = 8;
    }
