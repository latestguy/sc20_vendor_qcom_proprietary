...
PortBufferCapability PostProcSource::GetBufferRequirements(OMX_U32 ePortIndex) {
    ...
    sBufCap.nBufferUsage = m_bSecureSession ? (unsigned long)(GRALLOC_USAGE_PRIVATE_MM_HEAP |
            GRALLOC_USAGE_PROTECTED) : (unsigned long)(GRALLOC_USAGE_PRIVATE_IOMMU_HEAP);
