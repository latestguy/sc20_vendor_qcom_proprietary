S5K3M2XM_SENSOR_LIBS_PATH := $(call my-dir)
# ---------------------------------------------------------------------------
#                      Make the shared library (libmmcamera_s5k3m2xm)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(S5K3M2XM_SENSOR_LIBS_PATH)
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../actuators/$(CHROMATIX_VERSION)
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../../../includes/
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../../sensors/sensors
LOCAL_C_INCLUDES += \
...
LOCAL_SHARED_LIBRARIES += libmmcamera_pdaf
LOCAL_SHARED_LIBRARIES += libmmcamera_pdafcamif
