OV2680_ZS2P80F1_SENSOR_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#                      Make the shared library (libmmcamera_ov2680_zs2p80f1)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(OV2680_ZS2P80F1_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= ov2680_zs2p80f1_lib.c
LOCAL_MODULE           := libmmcamera_ov2680_zs2p80f1
