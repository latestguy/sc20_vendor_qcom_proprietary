HI843_8909_SENSOR_LIBS_PATH := $(call my-dir)

# ---------------------------------------------------------------------------
#                      Make the shared library (libmmcamera_hi843_preview)
# ---------------------------------------------------------------------------

include $(CLEAR_VARS)
LOCAL_PATH := $(HI843_8909_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= hi843_8909_lib.c
LOCAL_MODULE           := libmmcamera_hi843_8909
