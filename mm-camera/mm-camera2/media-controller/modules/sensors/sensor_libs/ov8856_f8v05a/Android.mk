OV8856_F8V05A_SENSOR_LIBS_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(OV8856_F8V05A_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= ov8856_f8v05a_lib.c
LOCAL_MODULE           := libmmcamera_ov8856_f8v05a
