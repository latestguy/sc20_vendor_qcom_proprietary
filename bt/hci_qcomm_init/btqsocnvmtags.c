...
{
  0x52, 0x01, 0x5F, 0x4F, 0x00, 0x0B, 0x00,
  0x0D, 0x00, 0x00, 0x00, 0x02, 0x00, 0x02,
  0x02, 0x00, 0x00, 0x10, 0x33, 0x73, 0x33,
  0x33, 0x07, 0x01, 0x00, 0x28, 0x00, 0x00,
  0x00, 0x0A, 0x10, 0x01, 0x72, 0x01, 0x2B,
  0x2B, 0x44, 0x4A, 0x47, 0x45, 0x45, 0x45,
  0x43, 0x44, 0x58, 0x57, 0x55, 0x54, 0x5A,
  0x59, 0x25, 0x40, 0x28, 0x28, 0x39, 0x3D,
  0x39, 0x3A, 0x3A, 0x3A, 0x38, 0x39, 0x44,
  0x44, 0x43, 0x42, 0x45, 0x45, 0x24, 0x36,
  0x19, 0x48, 0xA0, 0x0F, 0x14, 0x64, 0x0A,
  0x00, 0x08, 0x40, 0x20, 0x00, 0x01
};
...
static bt_qsoc_cfg_cst_element_type bt_qsoc_cfg_tag_159_riva_CLASS1[] = \
{
  0x1E, 0x01, 0x9F, 0x1B,
  0x08, 0x05, 0x05, 0x00, 0x5C, 0x1E, // Each of the 4 line denotes a device to be configured
  0x08, 0x06, 0x0E, 0x00, 0x50, 0x14,
...
)
{
   ...
   if (param_ptr->bt_qsoc_bredr_dev_class == BT_QSOC_DEV_CLASS2) {
       ...
       bt_qsoc_nvm_add_element((uint8 *)&bt_qsoc_cfg_tag_159_riva_CLASS1[0], FALSE);
   }
}
#ifdef NVM_TAG_INIT_DEBUG
/*==============================================================
