...
void * file_list_handler(void *req_pkt, uint16 pkt_len);
void * open_handler(void *req_pkt, uint16 pkt_len);
void * read_handler(void *req_pkt, uint16 pkt_len);
void * close_handler(void *req_pkt, uint16 pkt_len);
...
uint8 * bad_packet_len_handler(void *req_pkt, uint16 pkt_len)
{
	PACK(uint8 *)rsp = NULL;
