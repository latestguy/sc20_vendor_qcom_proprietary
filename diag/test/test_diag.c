/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
Copyright (c) 2007-2014, 2016, by Qualcomm Technologies, Inc.  All Rights Reserved.
...
Copyright (c) 2007-2014, 2016, Qualcomm Technologies, Inc.
All Rights Reserved.
...
void * dummy_func_128(void *req_pkt, uint16 pkt_len);

void * dummy_func_128_delay(void *req_pkt, uint16 pkt_len);

void * dummy_func_75_test(void *req_pkt, uint16 pkt_len);
