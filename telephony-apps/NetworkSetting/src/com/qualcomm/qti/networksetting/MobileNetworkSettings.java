...
public class MobileNetworkSettings extends PreferenceActivity
    ...
    private String BUTTON_PREFERED_NETWORK_MODE = "preferred_network_mode_key";
    private String BUTTON_PREFERED_NETWORK_MODE_VERIZON = "preferred_network_mode_verion_key";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        log("mOnCertificationMode : " + mOnCertificationMode);
        log("mBaseBandVersion : " + mBaseBandVersion);
        if (mOnCertificationMode){
            if (mBaseBandVersion.contains("SC20A") && !mBaseBandVersion.contains("SC20AU")){
                log("original BUTTON_PREFERED_NETWORK_MODE : " + BUTTON_PREFERED_NETWORK_MODE);
                BUTTON_PREFERED_NETWORK_MODE = BUTTON_PREFERED_NETWORK_MODE_VERIZON;
                log("new BUTTON_PREFERED_NETWORK_MODE : " + BUTTON_PREFERED_NETWORK_MODE);
            }
        }
    ...
    private void updateBody() {
        ...
        if (DBG) {
            log("updateBody: isLteOnCdma= " + isLteOnCdma + " phoneSubId= " + phoneSubId +
                    ...
                    " NW mode is: " + settingsNetworkMode);
        }
        ...
        if (prefSet != null) {
            ...
            if (mIsCTClassC) {
                ...
                if (uiccCard!= null && currentPrimarySlot == phoneId && settingsNetworkMode ==
