...
public class SimSettings extends PreferenceFragment {
    ...
    private void updateCellularDataValues() {
        ...
        simPref.setEnabled((mSelectableSubInfos.size() > 1) && !disableDds()
                && callStateIdle && !ecbMode  && !isAirplaneModeOn()
                && !isSubsidyUnlocked());
    }

    private boolean isManuaSubSelectionRequired() {
        return (isManualSubSelectRequired() || !isSubsidyUnlocked());
    }
