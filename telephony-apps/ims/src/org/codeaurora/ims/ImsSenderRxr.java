...
public final class ImsSenderRxr extends ImsPhoneBaseCommands implements ImsPhoneCommandsInterface {
    ...
    static final int EVENT_UNSOL_WAKE_LOCK_TIMEOUT = 3;
    ...
    static final int UNSOL_WAKELOCK_TIMEOUT_MS = 200;
    ...
    private Handler mUnsolWakeLockTimeoutHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case EVENT_UNSOL_WAKE_LOCK_TIMEOUT:
    ...
    public ImsSenderRxr(Context context)
    {
        ...
        mUnsolWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, LOG_TAG + "_UNSOL");
    ...
    private void acquireUnsolWakeLock() {
        ...
        synchronized (mUnsolWakeLock) {
            ...
            Message msg = mUnsolWakeLockTimeoutHandler.obtainMessage(EVENT_UNSOL_WAKE_LOCK_TIMEOUT);
            mUnsolWakeLockTimeoutHandler.sendMessageDelayed(msg, UNSOL_WAKELOCK_TIMEOUT_MS);
        }
    }
