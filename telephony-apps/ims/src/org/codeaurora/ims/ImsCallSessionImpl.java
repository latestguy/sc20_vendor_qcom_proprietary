...
public class ImsCallSessionImpl extends IImsCallSession.Stub {
        ...
        if (mDc == null) {
            ...
            if (mStateChangeReportingAllowed) {
                if ((changedProperties & DriverCallIms.UPDATE_IS_MPTY) != 0) {
                    ...
                    if (mTracker != null) {
                        mTracker.notifyMultiPartyStateChanged(this, mDc.isMpty);
                    }
                }
            }
    ...
    public void updateVideoCallDataUsageInfo(QtiVideoCallDataUsage dataUsage) {
        if (!(Config.isConfigEnabled(mContext,
                ...
                QtiImsExtUtils.isCarrierConfigEnabled(mContext,
                QtiCarrierConfigs.SHOW_DATA_USAGE_TOAST))) {
            Log.v(this, "updateVideoCallDataUsageInfo: data usage reporting not enabled");
            return;
        }
