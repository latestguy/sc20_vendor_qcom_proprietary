...
class CameraManager {
    ...
    private CameraManager(Context context) {
        ...
        setFactory(shallUseCamera2(mContext) ? new Camera2Factory() : new Camera1Factory());
    ...
    public static boolean shallUseCamera2(Context context) {
        Preconditions.checkNotNull(context);
        return context.getResources().getBoolean(org.codeaurora.ims.R.bool.config_use_camera2);
    }
}
