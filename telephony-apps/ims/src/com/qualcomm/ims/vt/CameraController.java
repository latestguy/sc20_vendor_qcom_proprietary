...
public class CameraController implements ImsMedia.CameraListener,
        ...
        synchronized (mSyncObject) {
            ...
            try {
                if (surface != null) {
                    ...
                    Log.d(this, "native width = " + previewWidth + " height = " +  previewHeight);
                    //Log.d(this, "old width = " + mPreviewWidth + " height = " + mPreviewHeight);
                    if ((mPreviewSurface != null
                            && !ImsMedia.haveSameParent(mPreviewSurface, surface)) ||
                            (CameraManager.shallUseCamera2(mContext) && mCamera != null &&
                            (mPreviewSize == null || !mPreviewSize.equals(size)))) {
    ...
    public void onCameraConfigChanged(int w, int h, int fps, Surface surface, int orientationMode) {
        ...
        try {
            if (!CameraManager.shallUseCamera2(mContext)) {
